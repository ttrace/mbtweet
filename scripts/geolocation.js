...
//	window.console.log( func_name + "=function( data ){insertGeoInfo(data,'" + target_id + "')}" );
	eval( func_name + "=function( data ){insertGeoInfo(data,'" + target_id + "')}" );
	var access_URL = "http://maps.google.com/maps/geo?q=" + ll[0] + "," + ll[1] + "&gl=" + gl + "&callback=" + func_name + "&output=json&sensor=true_or_false&key=" + googlemap_key;
